...
#*****************************************************************************80
#
## diffusion_advection simulates a simple 2D diffusion_advection problem.
#
#  Discussion:
#
...
#  Parameters:
#
#    Input, integer my_grid, the resolution on the unit interval; float my_range, the interval of resolution
#
...
#
  ...
  filename = ( 'trial_mesh_2d_grid_%d_zoom_x%g.png' % ( my_grid, (1/my_range) ) )
...
#
  ...
  plt.xlim([0, (my_range)])
  plt.ylim([0, (my_range)])
  plt.title ( 'trial_dif_adv_2d, grid %d, zoom x%g' % ( my_grid, (1/my_range) ) )
  filename = ( 'diffusion_convection_grid%d_zoom_x%g.png' % ( my_grid, (1/my_range) ) )
  plt.savefig ( filename )
  print ( '  Graphics saved as "%s"' % ( filename ) )
  plt.close ( )
#
